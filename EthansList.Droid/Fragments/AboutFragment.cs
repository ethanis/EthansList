...
namespace EthansList.Droid
{
    public class AboutFragment : Android.Support.V4.App.Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            view.Adapter = new AboutAdapter(this.Activity);

            return view;
        }
    }

    public class AboutAdapter : BaseAdapter<AboutEntry>
    {
        readonly Context _context;
        readonly List<AboutEntry> _abouts;

        public AboutAdapter(Context context)
        {
            _context = context;
            _abouts = AboutFields.All;
        }

        public override AboutEntry this[int position]
        {
            get
            {
                return _abouts[position];
            }
        }
        ...
        {
            var view = new AboutRow(_context, _abouts[position]);

            if (_abouts[position].Link != null)
            {
                view.Click += delegate
                {
                    var transaction = ((MainActivity)_context).SupportFragmentManager.BeginTransaction();
                    WebviewFragment webviewFragment = new WebviewFragment();
                    webviewFragment.Link = _abouts[position].Link;
    ...
    public class AboutRow : LinearLayout
    {
        readonly Context _context;
        readonly AboutEntry _about;

        public AboutRow(Context context, AboutEntry about)
            : base(context)
        {
            _context = context;
            _about = about;
        ...
        void Initialize()
        {
            ...
            TextView titleDisplay = new TextView(_context) { Text = _about.Title };
            ...
            titleDisplay.SetTextSize(ComplexUnitType.Dip, 22);
            ...
            TextView descriptionDisplay = new TextView(_context) { Text = _about.Description };
